...
public class TestVelocity {
  ...
  public void test() {
    ...
    try {
      String templates =
          Paths.get(System.getProperty("user.dir"), "test/facs/test/templates").toFile().toString();
      ...
      context.put("project_short_description",
          "FFPE Proteomics: Methodenetablierung und Experiment");
      ...
      map.put(
          "description",
          "for real this will be a longer exxample. I am a veeeerrrryyyyyy llooooonnnnggggg   description, that basically describes nothing for real!!!");
      map.put("cost", "1.50");
      list.add(map);
      ...
      File file =
          new File(Paths
              .get(System.getProperty("user.dir"), "test/facs/test/templates", "test.tex").toFile()
              .toString());
