...
public class FacsModelUtil {
  ...
  public static BookingModel getNoviceBookingModel() {
    ...
    while (iterator.hasNext()) {
      allBookings = db.getAllBookings(bookingModel.getLDAP(), deviceNames.get(iterator_index));
  ...
  public static BookingModel getInvoicingBookingModel() {
    ...
    while (iterator.hasNext()) {
      allBookings =
          db.getAllInvoicingBookings(bookingModel.getLDAP(), deviceNames.get(iterator_index));
      events.put(iterator.next(), allBookings);
      iterator_index++;
    }
