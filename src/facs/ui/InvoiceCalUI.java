...
import facs.components.InvoiceCal;
import facs.model.BookingModel;
import facs.model.FacsModelUtil;

@SuppressWarnings("serial")
@Theme("valo")
public class InvoiceCalUI extends UI {
  ...
  protected void init(VaadinRequest request) {
    ...
    try {
      ...
      InvoiceCal invoiceCal = new InvoiceCal(bookingModel, referenceDate);
      setContent(invoiceCal);
