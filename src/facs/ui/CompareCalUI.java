...
import facs.components.CompareCal;
import facs.model.BookingModel;
import facs.model.FacsModelUtil;

@SuppressWarnings("serial")
@Theme("valo")
public class CompareCalUI extends UI {
  ...
  protected void init(VaadinRequest request) {
    ...
    try {
      BookingModel bookingModel = FacsModelUtil.getCompareBookingModel();
      CompareCal compareCal = new CompareCal(bookingModel, referenceDate);
      setContent(compareCal);
